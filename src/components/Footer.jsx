  ...
  return (
    <div className='footer bg-footer'>
      <div className="wrapper flex items-center flex-wrap">
        <div className='lg:w-1/4 sm:w-1/2 flex flex-col items-center w-full p-8'>
          <img src={require("../assets/logo.png")} alt="" className='w-40 max-w-none'/>
          <div className='flex w-full justify-center gap-6 mt-10'>
            <img src={require("../assets/images/soicalicons/svg (1).png")} alt="" />
            <img src={require("../assets/images/soicalicons/svg (2).png")} alt="" />
            <img src={require("../assets/images/soicalicons/svg.png")} alt="" />
            <img src={require("../assets/images/soicalicons/Vector.png")} alt="" />
          </div>
        </div>
        ...
        <div className='lg:w-1/4 sm:w-1/2 flex flex-col items-center lg:items-start w-full p-5'>
          ...
          <p className='text-center'>Sign up for exclusive offers, new launches, original stories, events and more.</p>
            <input type="text" className='p-5 border-b-2 border-black outline-none' placeholder='Enter Email                   ->'/>
